...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    id<ToDoHandleMOC> child = (id<ToDoHandleMOC>)self.window.rootViewController;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "macula.soft.ToDoList" in the application's documents directory.
